...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
	...
	const [post, { select: editorPosts }]: [StartupCardType, { select: StartupCardType[] }] =
		await Promise.all([
	...
	const parsedContend = sanitizeHtml(md.render(post?.pitch || ''))
				...
				<div className="space-y-5 mt-10 max-w-4xl mx-auto">
					...
					{parsedContend ? (
						<article
							...
							dangerouslySetInnerHTML={{ __html: parsedContend }}
						/>
					) : (
